...
// ── ATK ────────────────────────────────────────────────────────────────────────
item.runeAtkS = { id: 'runeAtkS', type: 'rune', name: 'Rune S : Pui+10', stat: 'atk', value: 10, levelCost: 3, minRequiredLevel: 0, fusionCost: 5, image: 'img/items/runes/puissance1.png', description: '+10 ATK sur un slot Puissance existant.' }
item.runeAtkM = { id: 'runeAtkM', type: 'rune', name: 'Rune M : Pui+30', stat: 'atk', value: 30, levelCost: 7, minRequiredLevel: 80, fusionCost: 7, image: 'img/items/runes/puissance2.png', description: '+30 ATK sur un slot Puissance existant (item requis niv.80+).' }
item.runeAtkL = { id: 'runeAtkL', type: 'rune', name: 'Rune L : Pui+60', stat: 'atk', value: 60, levelCost: 12, minRequiredLevel: 150, fusionCost: 10, image: 'img/items/runes/puissance3.png', description: '+60 ATK sur un slot Puissance existant (item requis niv.150+).' }
// ── Force ──────────────────────────────────────────────────────────────────────
...
// ── Soins ──────────────────────────────────────────────────────────────────────
item.runeHealS = { id: 'runeHealS', type: 'rune', name: 'Rune S : Soin+5', stat: 'heal', value: 5, levelCost: 3, minRequiredLevel: 0, fusionCost: 5, image: 'img/items/runes/soin1.png', description: '+5 Soin sur un slot Soin existant.' }
item.runeHealM = { id: 'runeHealM', type: 'rune', name: 'Rune M : Soin+15', stat: 'heal', value: 15, levelCost: 7, minRequiredLevel: 80, fusionCost: 7, image: 'img/items/runes/soin2.png', description: '+15 Soin sur un slot Soin existant (item requis niv.80+).' }
item.runeHealL = { id: 'runeHealL', type: 'rune', name: 'Rune L : Soin+30', stat: 'heal', value: 30, levelCost: 12, minRequiredLevel: 150, fusionCost: 10, image: 'img/items/runes/soin3.png', description: '+30 Soin sur un slot Soin existant (item requis niv.150+).' }
// ── Critique ───────────────────────────────────────────────────────────────────
...
item.runeTransAtkS   = { id: 'runeTransAtkS',   type: 'rune', transcendance: true, name: 'Rune Trans ATK+10',      stat: 'atk',               value: 10,  levelCost: 3,  minRequiredLevel: 0,   image: 'img/items/runes/puissance1.png',             description: '+10 ATK sur n\'importe quel slot (forge exotique).' }
item.runeTransAtkM   = { id: 'runeTransAtkM',   type: 'rune', transcendance: true, name: 'Rune Trans ATK+30',      stat: 'atk',               value: 30,  levelCost: 7,  minRequiredLevel: 80,  image: 'img/items/runes/puissance2.png',             description: '+30 ATK sur n\'importe quel slot (forge exotique).' }
item.runeTransAtkL   = { id: 'runeTransAtkL',   type: 'rune', transcendance: true, name: 'Rune Trans ATK+60',     stat: 'atk',               value: 60, levelCost: 12, minRequiredLevel: 150, image: 'img/items/runes/puissance3.png',             description: '+60 ATK sur n\'importe quel slot (forge exotique).' }
...
item.runeTransHealS  = { id: 'runeTransHealS',  type: 'rune', transcendance: true, name: 'Rune Trans Soin+5',    stat: 'heal',            value: 5,   levelCost: 3,  minRequiredLevel: 0,   image: 'img/items/runes/soin1.png',                  description: '+5 Soin sur n\'importe quel slot (forge exotique).' }
item.runeTransHealM  = { id: 'runeTransHealM',  type: 'rune', transcendance: true, name: 'Rune Trans Soin+15',   stat: 'heal',            value: 15,  levelCost: 7,  minRequiredLevel: 80,  image: 'img/items/runes/soin2.png',                  description: '+15 Soin sur n\'importe quel slot (forge exotique).' }
item.runeTransHealL  = { id: 'runeTransHealL',  type: 'rune', transcendance: true, name: 'Rune Trans Soin+30',   stat: 'heal',            value: 30,  levelCost: 12, minRequiredLevel: 150, image: 'img/items/runes/soin3.png',                  description: '+30 Soin sur n\'importe quel slot (forge exotique).' }
...
// ────────────────────────────────────────────────────────────────────────
// #region Runes astrales ──────────────────────────────────────────────────
// maxRequiredLevel = niveau requis max de l'item sur lequel la rune est utilisable
//   (itm.requiredLevel <= maxRequiredLevel). Pas de borne basse : une rune de
//   palier élevé reste utilisable sur un item de faible niveau.
// Utilisées dans l'onglet "🌌 Astral" de la forge (applyAstralUpgrade) pour
// faire progresser le niveau astral d'un item déjà au niveau de forge max
// (+1% de toutes les stats par palier astral, jusqu'à +20%).
item.runeAstral20  = { id: 'runeAstral20',  type: 'runeAstrale', name: 'Rune Astrale I',    maxRequiredLevel: 20,  image: 'img/items/runes/astral1.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 20 (+1% de stats par palier)." }
item.runeAstral40  = { id: 'runeAstral40',  type: 'runeAstrale', name: 'Rune Astrale II',   maxRequiredLevel: 40,  image: 'img/items/runes/astral1.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 40 (+1% de stats par palier)." }
item.runeAstral60  = { id: 'runeAstral60',  type: 'runeAstrale', name: 'Rune Astrale III',  maxRequiredLevel: 60,  image: 'img/items/runes/astral2.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 60 (+1% de stats par palier)." }
item.runeAstral80  = { id: 'runeAstral80',  type: 'runeAstrale', name: 'Rune Astrale IV',   maxRequiredLevel: 80,  image: 'img/items/runes/astral2.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 80 (+1% de stats par palier)." }
item.runeAstral100 = { id: 'runeAstral100', type: 'runeAstrale', name: 'Rune Astrale V',    maxRequiredLevel: 100, image: 'img/items/runes/astral3.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 100 (+1% de stats par palier)." }
item.runeAstral120 = { id: 'runeAstral120', type: 'runeAstrale', name: 'Rune Astrale VI',   maxRequiredLevel: 120, image: 'img/items/runes/astral3.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 120 (+1% de stats par palier)." }
item.runeAstral140 = { id: 'runeAstral140', type: 'runeAstrale', name: 'Rune Astrale VII',  maxRequiredLevel: 140, image: 'img/items/runes/astral4.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 140 (+1% de stats par palier)." }
item.runeAstral160 = { id: 'runeAstral160', type: 'runeAstrale', name: 'Rune Astrale VIII', maxRequiredLevel: 160, image: 'img/items/runes/astral4.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 160 (+1% de stats par palier)." }
item.runeAstral180 = { id: 'runeAstral180', type: 'runeAstrale', name: 'Rune Astrale IX',   maxRequiredLevel: 180, image: 'img/items/runes/astral5.png',  description: "Fait progresser le niveau astral d'un item requis niveau ≤ 180 (+1% de stats par palier)." }
item.runeAstral200 = { id: 'runeAstral200', type: 'runeAstrale', name: 'Rune Astrale X',    maxRequiredLevel: 200, image: 'img/items/runes/astral6.png', description: "Fait progresser le niveau astral d'un item requis niveau ≤ 200 (+1% de stats par palier)." }
