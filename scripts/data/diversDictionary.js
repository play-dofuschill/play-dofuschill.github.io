...
item.runeCritDmgM = { id: 'runeCritDmgM', type: 'rune', name: 'Rune M : DégCrit+10%', stat: 'critDamagePct', value: 10, levelCost: 5, minRequiredLevel: 80, fusionCost: 7, image: 'img/items/runes/dommage_crit1.png', description: '+10% Dég.Crit sur un slot Dégâts Crit existant.' }
item.runeCritDmgL = { id: 'runeCritDmgL', type: 'rune', name: 'Rune L : DégCrit+25%', stat: 'critDamagePct', value: 25, levelCost: 9, minRequiredLevel: 150, fusionCost: 10, image: 'img/items/runes/dommage_crit2.png', description: '+25% Dég.Crit sur un slot Dégâts Crit existant (item requis niv.80+).' }
// ── Dégâts % ───────────────────────────────────────────────────────────────────
item.runeFinalDmgM = { id: 'runeFinalDmgM', type: 'rune', name: 'Rune M : DégFin+7%', stat: 'finalDamagePct', value: 7, levelCost: 7, minRequiredLevel: 80, fusionCost: 7, image: 'img/items/runes/dommage_finaux1.png', description: '+7% Dég.finaux sur un slot Dégâts finaux existant.' }
item.runeFinalDmgL = { id: 'runeFinalDmgL', type: 'rune', name: 'Rune L : DégFin+15%', stat: 'finalDamagePct', value: 15, levelCost: 12, minRequiredLevel: 150, fusionCost: 10, image: 'img/items/runes/dommage_finaux2.png', description: '+15% Dég.finaux sur un slot Dégâts finaux existant (item requis niv.80+).' }
item.runeSpellDmgM = { id: 'runeSpellDmgM', type: 'rune', name: 'Rune M : DégSort+8%', stat: 'spellDamagePct', value: 8, levelCost: 7, minRequiredLevel: 80, fusionCost: 7, image: 'img/items/runes/SpellDamage1.png', description: '+8% Dég.sorts sur un slot Dégâts sorts existant.' }
item.runeSpellDmgL = { id: 'runeSpellDmgL', type: 'rune', name: 'Rune L : DégSort+20%', stat: 'spellDamagePct', value: 20, levelCost: 12, minRequiredLevel: 150, fusionCost: 10, image: 'img/items/runes/SpellDamage2.png', description: '+20% Dég.sorts sur un slot Dégâts sorts existant (item requis niv.80+).' }
// ── Défensif ───────────────────────────────────────────────────────────────────
