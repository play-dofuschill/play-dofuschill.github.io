...
// ── Monstre Ignemikhal (étend l'objet `monsters`) ──────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Dragons non activés — conservés pour référence future. Écrits dans l'ancien
// schéma (Boss_UltimeDragons / Boss_UltimeMoves) du moteur de combat dédié qui a
// été supprimé : à convertir vers le schéma ci-dessus (monsters[...] + move[...]
// + BossUltimeDragons[...].phase2) le jour de leur activation.
// ─────────────────────────────────────────────────────────────────────────────

// const Boss_UltimeDragons_INACTIF = {
//     'dragon_Aguabrial': {
//         id:   'dragon_Aguabrial',
...
// const Boss_UltimeMoves_INACTIF = {
//     // ── Aguabrial Phase 1 ────────────────────────────────────────────────────────
