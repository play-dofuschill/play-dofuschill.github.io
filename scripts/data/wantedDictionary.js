...
monsters['wanted_sam_sagaz'] = {
    ...
    tier: 'boss',
    fixedLevel: 20,
    bst: { hp: 6500, atk: 35, spd: 112, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_fouduglen_l_ecureuil'] = {
    ...
    tier: 'boss',
    fixedLevel: 20,
    bst: { hp: 6700, atk: 65, spd: 112, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_maitre_boulet'] = {
    ...
    tier: 'boss',
    fixedLevel: 30,
    bst: { hp: 12000, atk: 97, spd: 112, res: { neutre: -10, feu: 10, eau: 10, air: 10, terre: 10 } },
...
monsters['wanted_frakacia_leukocytine'] = {
    ...
    tier: 'boss',
    fixedLevel: 30,
    bst: { hp: 13000, atk: 123, spd: 112, res: { neutre: 15, feu: 5, eau: -10, air: 25, terre: -20 } },
...
monsters['wanted_ambi_guman'] = {
    ...
    tier: 'boss',
    fixedLevel: 30,
    bst: { hp: 14000, atk: 78, spd: 112, res: { neutre: 20, feu: 20, eau: 10, air: 20, terre: 10 } },
...
monsters['wanted_exi_guman'] = {
    ...
    tier: 'boss',
    fixedLevel: 30,
    bst: { hp: 11000, atk: 84, spd: 112, res: { neutre: 30, feu: 5, eau: 5, air: -10, terre: 10 } },
...
monsters['wanted_roub_ignolles'] = {
    ...
    tier: 'boss',
    fixedLevel: 40,
    bst: { hp: 12000, atk: 150, spd: 124, res: { neutre: 20, feu: 10, eau: 10, air: 10, terre: 0 } },
...
monsters['wanted_bouss_baybe'] = {
    ...
    tier: 'boss',
    fixedLevel: 50,
    bst: { hp: 31000, atk: 238, spd: 124, res: { neutre: 15, feu: 5, eau: 0, air: 10, terre: 20 } },
...
monsters['wanted_ogivol_scalarcin'] = {
    ...
    tier: 'boss',
    fixedLevel: 50,
    bst: { hp: 31000, atk: 163, spd: 124, res: { neutre: 10, feu: -15, eau: -20, air: 25, terre: 20 } },
...
monsters['wanted_nono_le_wobot'] = {
    ...
    tier: 'boss',
    fixedLevel: 60,
    bst: { hp: 41000, atk: 231, spd: 136, res: { neutre: 10, feu: -10, eau: -10, air: 20, terre: 20 } },
...
monsters['wanted_brumen_tinctorias'] = {
    ...
    tier: 'boss',
    fixedLevel: 60,
    bst: { hp: 43000, atk: 210, spd: 136, res: { neutre: 15, feu: 20, eau: -15, air: 5, terre: -10 } },
...
monsters['wanted_marzwel_le_gobelin'] = {
    ...
    tier: 'boss',
    fixedLevel: 60,
    bst: { hp: 41000, atk: 217, spd: 136, res: { neutre: 0, feu: 0, eau: 20, air: 0, terre: 0 } },
...
monsters['wanted_qil_bil'] = {
    ...
    tier: 'boss',
    fixedLevel: 70,
    bst: { hp: 53000, atk: 248, spd: 136, res: { neutre: 10, feu: 10, eau: -19, air: 0, terre: 12 } },
...
monsters['wanted_aermyne_braco_scalptaras'] = {
    ...
    tier: 'boss',
    fixedLevel: 80,
    bst: { hp: 66000, atk: 333, spd: 148, res: { neutre: 60, feu: 30, eau: 10, air: 20, terre: -20 } },
...
monsters['wanted_musha_l_oni'] = {
    ...
    tier: 'boss',
    fixedLevel: 80,
    bst: { hp: 66000, atk: 296, spd: 148, res: { neutre: 90, feu: 90, eau: 90, air: 90, terre: 90 } },
...
monsters['wanted_tyranne_la_terrible'] = {
    ...
    tier: 'boss',
    fixedLevel: 80,
    bst: { hp: 66000, atk: 410, spd: 148, res: { neutre: 10, feu: 0, eau: 15, air: -10, terre: 15 } },
...
monsters['wanted_rok_gnorok'] = {
    ...
    tier: 'boss',
    fixedLevel: 90,
    bst: { hp: 79000, atk: 333, spd: 148, res: { neutre: 22, feu: 22, eau: 22, air: 22, terre: 22 } },
...
monsters['wanted_simbadas'] = {
    ...
    tier: 'boss',
    fixedLevel: 90,
    bst: { hp: 80000, atk: 447, spd: 148, res: { neutre: -15, feu: 28, eau: 14, air: 13, terre: -5 } },
...
monsters['wanted_prince_marchand'] = {
    ...
    tier: 'boss',
    fixedLevel: 100,
    bst: { hp: 96000, atk: 420, spd: 160, res: { neutre: 50, feu: 15, eau: 10, air: 5, terre: 0 } },
...
monsters['wanted_naganita'] = {
    ...
    tier: 'boss',
    fixedLevel: 100,
    bst: { hp: 94000, atk: 512, spd: 160, res: { neutre: -5, feu: -20, eau: 10, air: 20, terre: 15 } },
...
monsters['wanted_carlita_de_l_aguerfelde'] = {
    ...
    tier: 'boss',
    fixedLevel: 100,
    bst: { hp: 94000, atk: 375, spd: 160, res: { neutre: 20, feu: -20, eau: 35, air: -5, terre: 5 } },
...
monsters['wanted_bouflouth'] = {
    ...
    tier: 'boss',
    fixedLevel: 120,
    bst: { hp: 130000, atk: 482, spd: 172, res: { neutre: 80, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_morblok'] = {
    ...
    tier: 'boss',
    fixedLevel: 120,
    bst: { hp: 120000, atk: 460, spd: 172, res: { neutre: 20, feu: -5, eau: 5, air: 30, terre: 15 } },
...
monsters['wanted_nenufor_tilotus'] = {
    ...
    tier: 'boss',
    fixedLevel: 120,
    bst: { hp: 130000, atk: 467, spd: 172, res: { neutre: 0, feu: -15, eau: 10, air: -5, terre: 20 } },
...
monsters['wanted_monsieur_pingouin'] = {
    ...
    tier: 'boss',
    fixedLevel: 130,
    bst: { hp: 140000, atk: 612, spd: 172, res: { neutre: 0, feu: 0, eau: 50, air: 20, terre: 0 } },
...
monsters['wanted_padgref_demoel'] = {
    ...
    tier: 'boss',
    fixedLevel: 130,
    bst: { hp: 160000, atk: 698, spd: 172, res: { neutre: 30, feu: 15, eau: -15, air: -10, terre: -15 } },
...
monsters['wanted_ali_grothor'] = {
    ...
    tier: 'boss',
    fixedLevel: 130,
    bst: { hp: 140000, atk: 503, spd: 172, res: { neutre: 20, feu: 30, eau: -15, air: 25, terre: 10 } },
...
monsters['wanted_katigrou'] = {
    ...
    tier: 'boss',
    fixedLevel: 140,
    bst: { hp: 150000, atk: 555, spd: 184, res: { neutre: 50, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_fojumo'] = {
    ...
    tier: 'boss',
    fixedLevel: 140,
    bst: { hp: 160000, atk: 573, spd: 184, res: { neutre: -15, feu: 5, eau: 15, air: 10, terre: 10 } },
...
monsters['wanted_fantomayte'] = {
    ...
    tier: 'boss',
    fixedLevel: 150,
    bst: { hp: 180000, atk: 591, spd: 184, res: { neutre: 25, feu: 30, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_zatoishwan'] = {
    ...
    tier: 'boss',
    fixedLevel: 150,
    bst: { hp: 180000, atk: 588, spd: 184, res: { neutre: 20, feu: 80, eau: 60, air: 40, terre: 100 } },
...
monsters['wanted_vengeuse_masquee'] = {
    ...
    tier: 'boss',
    fixedLevel: 160,
    bst: { hp: 200000, atk: 644, spd: 196, res: { neutre: 200, feu: 25, eau: 200, air: 25, terre: 25 } },
...
monsters['wanted_anatak_diskedor'] = {
    ...
    tier: 'boss',
    fixedLevel: 160,
    bst: { hp: 200000, atk: 694, spd: 196, res: { neutre: 0, feu: -5, eau: 20, air: 15, terre: 15 } },
...
monsters['wanted_yech_ti'] = {
    ...
    tier: 'boss',
    fixedLevel: 170,
    bst: { hp: 220000, atk: 673, spd: 196, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_dremoan'] = {
    ...
    tier: 'boss',
    fixedLevel: 180,
    bst: { hp: 240000, atk: 715, spd: 208, res: { neutre: 60, feu: 0, eau: 50, air: 40, terre: 50 } },
...
monsters['wanted_carter_le_pillard'] = {
    ...
    tier: 'boss',
    fixedLevel: 180,
    bst: { hp: 250000, atk: 838, spd: 208, res: { neutre: 50, feu: 30, eau: 10, air: 100, terre: 10 } },
...
monsters['wanted_guerrier_du_k_o'] = {
    ...
    tier: 'boss',
    fixedLevel: 180,
    bst: { hp: 240000, atk: 985, spd: 208, res: { neutre: 20, feu: 10, eau: 5, air: -20, terre: 15 } },
...
monsters['wanted_shushu_debruk_sayl'] = {
    ...
    tier: 'boss',
    fixedLevel: 180,
    bst: { hp: 250000, atk: 775, spd: 208, res: { neutre: 3, feu: 33, eau: 33, air: 33, terre: 33 } },
...
monsters['wanted_flasho'] = {
    ...
    tier: 'boss',
    fixedLevel: 190,
    bst: { hp: 240000, atk: 203, spd: 208, res: { neutre: 30, feu: 50, eau: 10, air: 50, terre: 0 } },
...
monsters['wanted_viti_glourson'] = {
    ...
    tier: 'boss',
    fixedLevel: 190,
    bst: { hp: 290000, atk: 168, spd: 208, res: { neutre: 50, feu: 10, eau: 0, air: 10, terre: 30 } },
...
monsters['wanted_fuji_givrefoux'] = {
    ...
    tier: 'boss',
    fixedLevel: 190,
    bst: { hp: 270000, atk: 591, spd: 208, res: { neutre: -6, feu: 14, eau: 12, air: -11, terre: 6 } },
...
monsters['wanted_docteur_eggob'] = {
    ...
    tier: 'boss',
    fixedLevel: 190,
    bst: { hp: 280000, atk: 478, spd: 208, res: { neutre: 200, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_sans_visage'] = {
    ...
    tier: 'boss',
    fixedLevel: 190,
    bst: { hp: 270000, atk: 665, spd: 208, res: { neutre: 50, feu: 20, eau: 5, air: 10, terre: 15 } },
...
monsters['wanted_predagob'] = {
    ...
    tier: 'boss',
    fixedLevel: 190,
    bst: { hp: 260000, atk: 234, spd: 208, res: { neutre: 40, feu: 10, eau: 25, air: 20, terre: 70 } },
...
monsters['wanted_buldalazred'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 290000, atk: 980, spd: 220, res: { neutre: 35, feu: 10, eau: 20, air: 5, terre: 25 } },
...
monsters['wanted_takomako'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 290000, atk: 2067, spd: 220, res: { neutre: 20, feu: 35, eau: 25, air: 5, terre: 10 } },
...
monsters['wanted_homard_medali'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 290000, atk: 1026, spd: 220, res: { neutre: 15, feu: -5, eau: 10, air: 30, terre: 20 } },
...
monsters['wanted_glourdorak'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 340000, atk: 471, spd: 220, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_mekamouth'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 340000, atk: 869, spd: 220, res: { neutre: 25, feu: 50, eau: -15, air: -20, terre: 35 } },
...
monsters['wanted_culbutuf'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 174, spd: 220, res: { neutre: 25, feu: 40, eau: 35, air: -10, terre: -15 } },
...
monsters['wanted_chevalier_de_glace'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 320000, atk: 534, spd: 220, res: { neutre: 25, feu: -15, eau: -20, air: 35, terre: 50 } },
...
monsters['wanted_psikopompe'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 320000, atk: 451, spd: 220, res: { neutre: 25, feu: -25, eau: 50, air: 45, terre: -20 } },
...
monsters['wanted_le_fantome_braideur'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 1027, spd: 220, res: { neutre: 15, feu: 10, eau: 35, air: 35, terre: 15 } },
...
monsters['wanted_voldelor'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 290000, atk: 833, spd: 220, res: { neutre: 20, feu: 35, eau: -5, air: 15, terre: 10 } },
...
monsters['wanted_sicogne'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 290000, atk: 1141, spd: 220, res: { neutre: 30, feu: -10, eau: 15, air: 35, terre: 20 } },
...
monsters['wanted_mi'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 2512, spd: 220, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_fou'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 4033, spd: 220, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_chi'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 1111, spd: 220, res: { neutre: 15, feu: 15, eau: 15, air: 15, terre: 15 } },
...
monsters['wanted_ganos'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 250000, atk: 1065, spd: 220, res: { neutre: 20, feu: -5, eau: 15, air: 15, terre: 15 } },
...
monsters['wanted_hyperscampe'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 551, spd: 220, res: { neutre: 40, feu: 30, eau: 15, air: 25, terre: 10 } },
...
monsters['wanted_grand_kongoku'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 300000, atk: 2571, spd: 220, res: { neutre: 15, feu: 15, eau: -10, air: -5, terre: 20 } },
...
monsters['wanted_khepricorne'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 320000, atk: 703, spd: 220, res: { neutre: 15, feu: 25, eau: 5, air: 10, terre: 20 } },
...
monsters['wanted_panteroz'] = {
    ...
    tier: 'boss',
    fixedLevel: 150,
    bst: { hp: 60000, atk: 597, spd: 184, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_gein'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 240000, atk: 11150, spd: 220, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
...
monsters['wanted_cire_momore'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 700000, atk: 687, spd: 220, res: { neutre: 27, feu: 27, eau: 27, air: 27, terre: 27 } },
...
monsters['wanted_gargandyas'] = {
    ...
    tier: 'boss',
    fixedLevel: 200,
    bst: { hp: 100000, atk: 659, spd: 220, res: { neutre: 0, feu: 0, eau: 0, air: 0, terre: 0 } },
