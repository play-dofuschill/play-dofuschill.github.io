...
const CLASS_OBTAIN = {
        ...
        roublard:   "Artificier kamikaze au sens du danger... inexistant, vous ne le recruterez pas, car il n'accepte dans ses rangs que les téméraires ayant survécu aux pires affrontements... (Enfin, c'est son amour-propre qui parle ; il saura vous prêter main-forte contre quelques kamas).", // vaincre le capitaine Ekarlatte
        ...
        eliotrope:  "Maître des portails dont les arcanes transcendent l'espace, cet être à l'apparence rappelant celle des dragons ne vous rejoindra que si vous êtes plus fort qu'eux.", // vaincre au moins un Boss Ultime
}
